                ...
                <div className="row">
                    <div className="col-lg-12">
                        <div className="bs-component">
                            ...
                            <FormGroup label="Instituição de Ensino: *" htmlFor="inputInstituicaoEnsino">
                                <input type="text"
                            ...
                            <FormGroup label="Nome do Programa de Ensino: *" htmlFor="inputNomeProgrmaEnsino">
                                <input type="text"
...
export default withRouter(CadastroUsuarioProfessor)